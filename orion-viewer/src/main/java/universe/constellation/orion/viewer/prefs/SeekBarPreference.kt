...
class SeekBarPreference @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) :
        DialogPreference(context, attrs), SeekBar.OnSeekBarChangeListener, OrionPreference {
    ...
    init {
        ...
        //dialogLayoutResource = R.layout.dialog_slider
    }
    ...
    override fun onBindViewHolder(holder: PreferenceViewHolder) {
        ...
        (holder.findViewById(R.id.min_value) as TextView).text = Integer.toString(minValue)
        (holder.findViewById(R.id.max_value) as TextView).text = Integer.toString(maxValue)
        ...
        mValueText = holder.findViewById(R.id.current_value) as TextView
