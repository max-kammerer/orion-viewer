...
public class DataBaseInsertException extends OrionException {
    ...
    public DataBaseInsertException(Activity activity,int messageId, String subMessage) {
          super(activity, messageId, subMessage);
    }

    public DataBaseInsertException(String message, String subMessage) {
